...
template void polyvec_compress<2>(const PolyVec<2>&, size_t, std::span<uint8_t>);
template void polyvec_compress<3>(const PolyVec<3>&, size_t, std::span<uint8_t>);
template void polyvec_compress<4>(const PolyVec<4>&, size_t, std::span<uint8_t>);

template void polyvec_decompress<2>(PolyVec<2>&, size_t, std::span<const uint8_t>);
template void polyvec_decompress<3>(PolyVec<3>&, size_t, std::span<const uint8_t>);
template void polyvec_decompress<4>(PolyVec<4>&, size_t, std::span<const uint8_t>);
...
template void polyvec_basemul_acc_montgomery<2>(Poly&, const PolyVec<2>&, const PolyVec<2>&);
template void polyvec_basemul_acc_montgomery<3>(Poly&, const PolyVec<3>&, const PolyVec<3>&);
template void polyvec_basemul_acc_montgomery<4>(Poly&, const PolyVec<4>&, const PolyVec<4>&);

template void polyvec_reduce<2>(PolyVec<2>&);
template void polyvec_reduce<3>(PolyVec<3>&);
template void polyvec_reduce<4>(PolyVec<4>&);

template void polyvec_add<2>(PolyVec<2>&, const PolyVec<2>&, const PolyVec<2>&);
template void polyvec_add<3>(PolyVec<3>&, const PolyVec<3>&, const PolyVec<3>&);
template void polyvec_add<4>(PolyVec<4>&, const PolyVec<4>&, const PolyVec<4>&);
